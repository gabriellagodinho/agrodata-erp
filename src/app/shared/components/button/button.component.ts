  ...
  get buttonClasses(): string {
    ...
    switch (this.variant) {
      case 'primary':
        ...
        break;
      case 'secondary':
        variantClasses = 'bg-gray-200 hover:bg-gray-300 text-gray-700 focus:ring-gray-500';
        break;
      case 'danger':
      ...
      case 'info':
        ...
        break;
      case 'light':
        variantClasses = 'bg-gray-100 hover:bg-gray-200 text-gray-800 focus:ring-gray-300';
        break;
      case 'dark':
        variantClasses = 'bg-gray-800 hover:bg-gray-900 text-white focus:ring-gray-700';
        break;
    }
